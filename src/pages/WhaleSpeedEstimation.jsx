    ...
    <div className="py-10 md:py-14 px-4 md:px-8">
      <div className="max-w-5xl mx-auto">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-foreground mb-4">Kinematic Sensor Data Approach</h2>
          ...
          <ul className="list-disc list-inside text-muted space-y-2 mb-6">
            <li>Use extracted features as inputs (<code className="bg-surface-elevated px-2 py-1 rounded">X</code>) and known speed (<code className="bg-surface-elevated px-2 py-1 rounded">speedJJ</code>) as the target (<code className="bg-surface-elevated px-2 py-1 rounded">y</code>).</li>
          ...
          <p className="text-muted-foreground italic mb-3">Evaluation metrics:</p>
...
Test R²: 0.92
          ...
          <h3 className="text-2xl font-semibold text-foreground mb-4">Results Visualization</h3>
          <ul className="list-disc list-inside text-muted space-y-2 mb-6">
            <li>Plot predicted vs actual speed values for the test set to assess model accuracy visually.</li>
          </ul>

          <p className="text-muted-foreground italic mb-4">Resulting plot:</p>
        ...
        {/* Optical Flow Method */}
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-foreground mb-4">Optical Flow Method</h2>
          ...
          <h2 className="text-3xl font-bold text-foreground mb-4 mt-8">Speed Estimation Using Optical Flow</h2>
          <p className="text-muted mb-4 leading-relaxed">
        ...
        {/* Lucas-Kanade Method */}
        <section className="mb-12">
          <h1 className="text-3xl font-bold text-foreground mb-4">Method 2.1: Lucas-Kanade Method</h1>
          <p className="text-muted mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl font-semibold text-foreground mb-4">Core Principles</h2>
          ...
          <h2 className="text-2xl font-semibold text-foreground mb-4 mt-8">Mathematical Formulation</h2>
          <p className="text-muted mb-3 leading-relaxed">
          ...
          <div className="bg-surface p-4 rounded-lg mb-6 text-center">
            <p className="text-foreground font-mono">I(x, y, t) = I(x + dx, y + dy, t + dt)</p>
          </div>
          ...
          <div className="bg-surface p-4 rounded-lg mb-6 text-center">
            <p className="text-foreground font-mono">I<sub>x</sub>u + I<sub>y</sub>v + I<sub>t</sub> = 0</p>
          </div>

          <p className="text-muted mb-3 leading-relaxed">Where:</p>
          <ul className="list-disc list-inside text-muted space-y-2 mb-6 ml-4">
          ...
          <h2 className="text-2xl font-semibold text-foreground mb-4 mt-8">Speed Calculation Steps</h2>
          
          <h3 className="text-xl font-semibold text-foreground mb-3">1. Calibration</h3>
          <p className="text-muted mb-6 leading-relaxed">
          ...
          <h3 className="text-xl font-semibold text-foreground mb-3">2. Flow Vector Calculation</h3>
          <p className="text-muted mb-6 leading-relaxed">
            Apply the Lucas-Kanade method to obtain flow vectors (u,v) between consecutive frames.
          </p>

          <h3 className="text-xl font-semibold text-foreground mb-3">3. Magnitude Calculation</h3>
          <p className="text-muted mb-3 leading-relaxed">Calculate the magnitude of the flow vector:</p>
          <div className="bg-surface p-4 rounded-lg mb-6 text-center">
            <p className="text-foreground font-mono">||V|| = √(u² + v²)</p>
          </div>

          <h3 className="text-xl font-semibold text-foreground mb-3">4. Speed Conversion</h3>
          <p className="text-muted mb-3 leading-relaxed">Convert the flow magnitude to actual speed:</p>
          <div className="bg-surface p-4 rounded-lg mb-6 text-center">
            <p className="text-foreground font-mono">Speed = (||V|| × Scale × FPS) / Calibration Factor</p>
          </div>
        ...
        <section className="mb-12">
          ...
          <a 
            ...
            className="text-accent hover:text-accent-hover underline mb-6 block"
          >
            Reference Paper: arxiv.org/html/2407.13159v1
          </a>

          <div className="overflow-x-auto mb-8">
            <table className="w-full bg-surface-elevated rounded-lg overflow-hidden">
              <thead className="bg-surface-elevated">
                <tr>
                  <th className="px-6 py-3 text-left text-foreground font-semibold">Video</th>
                  <th className="px-6 py-3 text-left text-foreground font-semibold">What it shows</th>
                  <th className="px-6 py-3 text-left text-foreground font-semibold">Why it's useful</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-t border-border">
                  <td className="px-6 py-4 text-foreground font-semibold">Optical Flow Video</td>
                  <td className="px-6 py-4 text-muted">Motion direction & speed per pixel (color-coded vectors)</td>
                  <td className="px-6 py-4 text-muted">See how the camera or environment is moving</td>
                </tr>
                <tr className="border-t border-border">
                  <td className="px-6 py-4 text-foreground font-semibold">Weights / Attenuation Map Video</td>
                  <td className="px-6 py-4 text-muted">Clarity/confidence of each pixel's motion</td>
                  <td className="px-6 py-4 text-muted">Identify reliable vs unreliable regions under water</td>
                </tr>
              </tbody>
            </table>
          </div>

          <h3 className="text-2xl font-semibold text-foreground mb-4">1. Flow Video</h3>
          <h4 className="text-xl font-semibold text-foreground mb-3">What it represents</h4>
          <ul className="list-disc list-inside text-muted space-y-2 mb-6 ml-4">
          ...
          <h4 className="text-xl font-semibold text-foreground mb-3">💡 How to read it</h4>
          <ul className="list-disc list-inside text-muted space-y-2 mb-6 ml-4">
          ...
          <h3 className="text-2xl font-semibold text-foreground mb-4">2. Weights Video</h3>
          <p className="text-muted mb-6 leading-relaxed">
        ...
        <section className="mb-12">
          ...
          <h3 className="text-2xl font-semibold text-foreground mb-4">Underwater Fish Detection</h3>
          <img
          ...
          <h3 className="text-2xl font-semibold text-foreground mb-4 mt-8">Navigation and Object Avoidance</h3>
          <div className="flex flex-col gap-6 mb-8">
            <img
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-surface-elevated p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-foreground mb-3">Particle Density Estimation (and Size)</h3>
              <p className="text-muted">Using optical flow to analyze and estimate particle distribution in marine environments.</p>
            </div>
            <div className="bg-surface-elevated p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-foreground mb-3">Water Clarity Estimation</h3>
              <p className="text-muted">Assessing water quality and visibility through motion analysis and light attenuation.</p>
            </div>
            <div className="bg-surface-elevated p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-foreground mb-3">Light Penetration</h3>
              <p className="text-muted">Measuring how light propagates through water at different depths and conditions.</p>
            </div>
          </div>
        </section>
