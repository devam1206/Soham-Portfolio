    ...
    <div className="py-10 px-4 md:px-8 bg-[#0a0a0a] min-h-screen">
      <div className="max-w-5xl mx-auto">
        ...
        <section className="mb-12">
          ...
          <h3 className="text-2xl font-semibold text-white mb-4">Key Technologies</h3>
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold text-white mb-6">Technical Documentation</h2>
          
          <div className="space-y-6">
            <div className="bg-slate-800 p-6 rounded-lg">
              <h4 className="text-xl font-semibold text-white mb-3">Research Paper 1</h4>
            ...
            <div className="bg-slate-800 p-6 rounded-lg">
              <h4 className="text-xl font-semibold text-white mb-3">Research Paper 2</h4>
              <p className="text-slate-300 mb-4">
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-slate-800 p-6 rounded-lg">
              <h4 className="text-xl font-semibold text-white mb-3">Underwater Sensor Networks</h4>
            ...
            <div className="bg-slate-800 p-6 rounded-lg">
              <h4 className="text-xl font-semibold text-white mb-3">Autonomous Underwater Vehicles (AUVs)</h4>
              <p className="text-slate-300">
            ...
            <div className="bg-slate-800 p-6 rounded-lg">
              <h4 className="text-xl font-semibold text-white mb-3">Offshore Operations</h4>
              <p className="text-slate-300">
            ...
            <div className="bg-slate-800 p-6 rounded-lg">
              <h4 className="text-xl font-semibold text-white mb-3">Marine Research</h4>
              <p className="text-slate-300">
